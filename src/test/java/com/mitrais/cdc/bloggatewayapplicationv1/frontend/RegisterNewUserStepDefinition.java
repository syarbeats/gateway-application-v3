package com.mitrais.cdc.bloggatewayapplicationv1.frontend;
...
public class RegisterNewUserStepDefinition {
    ...
    public void when_user_has_been_registered_successfully_will_go_to_register_successfully_url() {
        ...
        //Assert.assertTrue("User has been Registered successfully", expectedMessage.equals(actualMessage));
        assertThat("Please check your email to active your your account !!!! Login", is(actualMessage));
    }
